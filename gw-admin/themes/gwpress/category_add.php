...
if(!empty($_POST)) {
    ...
    $category->category_save('', ''.$title.'', ''.$description.'', ''.$featured.'', ''.$metadescription.'', ''.$metakeywords.'');
}
?>
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h1 class="page-header">Categories</h1>
    <form class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?php echo BASE_URL; ?>/admin/categories/add">
